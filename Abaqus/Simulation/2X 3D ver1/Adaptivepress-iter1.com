...
options = {
    ...
    'input':'Adaptivepress-iter1',
    'inputFormat':INP,
    'interpolExtList':['.odb', '.sim', '.SMAManifest'],
    'job':'Adaptivepress-iter1',
    'keyword_licenses':[],
    'lanczos':OFF,
    'libs':[],
    'listener_name':'host.docker.internal',
    'listener_resource':'37232',
    'magnetostatic':OFF,
    'massDiffusion':OFF,
    ...
    'mp_head_node':('host.docker.internal', 'host', 'gateway.docker.internal', '192.168.178.171', 'pcmtr.mshome.net', 'pcmtr', '172.24.144.1'),
    'mp_host_list':(('pcmtr', 6),),
    'mp_mode':MPI,
    'mp_mode_requested':MPI,
    'mp_mpi_validate':OFF,
    'mp_rsh_command':'dummy %H -l caber -n %C',
    'multiphysics':OFF,
    'noDmpDirect':[],
    'noMultiHost':[],
    'noMultiHostElemLoop':[],
    ...
    'thermal':OFF,
    'tmpdir':'C:\\Users\\caber\\AppData\\Local\\Temp',
    'tracer':OFF,
