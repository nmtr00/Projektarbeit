...
options = {
    ...
    'input':'Adaptivity-1-iter1',
    'inputFormat':INP,
    'interpolExtList':['.odb', '.sim', '.SMAManifest'],
    'job':'Adaptivity-1-iter1',
    'keyword_licenses':[],
    'lanczos':OFF,
    'libs':[],
    'listener_name':'host.docker.internal',
    'listener_resource':'35860',
    'magnetostatic':OFF,
    'massDiffusion':OFF,
    ...
    'mp_head_node':('host.docker.internal', 'host', 'gateway.docker.internal', '192.168.178.171', 'pcmtr'),
